/*! bdtUIkit 3.15.10 | https://www.getuikit.com | (c) 2014 - 2022 YOOtheme | MIT License */ (function (
  ue,
  de
) {
  ...
  const Fe = { ratio: Ci, contain: gs, cover: go };
  function Ut(t, e, i, s) {
  ...
  function v(t, e, i) {
    ...
    } else for (const n of $(t)) mt(i) && (i = i.call(n, v(n, e))), i === null ? me(n, e) : n.setAttribute(e, i);
  }
  function It(t, e) {
  ...
  function ot(t, e) {
    for (const i of [e, "data-" + e]) if (It(t, i)) return v(t, i);
  }
  const mo = {
    area: !0,
    base: !0,
  ...
  function vs(t, e) {
    return (
      e === void 0 && (e = document),
      (B(t) && ms(t)) || De(e) ? e : e.ownerDocument
    );
  }
  const wo = /([!>+~-])(?=\s+[!>+~-]|\s*$)/g,
  ...
  function k() {
    ...
    r.length > 1 && (r = So(r)),
      a != null && a.self && (r = To(r)),
      o && (r = ko(o, r));
    for (const l of n) for (const c of s) c.addEventListener(l, r, a);
    return () => Nt(s, n, r, a);
  }
  function Nt() {
    for (var t = arguments.length, e = new Array(t), i = 0; i < t; i++)
  ...
  function H(t, e, i) {
    const s = Ni(e);
    R(i) || (i = !!i);
    for (const n of $(t)) for (const o of s) n.classList.toggle(o, i);
  }
  function $s(t, e, i) {
  ...
  function C(t, e) {
    ...
    $t(h(t, ["left", "top"]), (n, o) =>
      h(t, o, e[o] - i[o] + w(s === "absolute" && n === "auto" ? je(t)[o] : n))
    );
  }
  function je(t) {
    ...
    if (Kt(r)) {
      const a = C(r);
      (e -= a.top + w(h(r, "borderTopWidth"))),
        (i -= a.left + w(h(r, "borderLeftWidth")));
    }
    return { top: e - w(h(t, "marginTop")), left: i - w(h(t, "marginLeft")) };
  }
  function Ht(t) {
    t = j(t);
    ...
    for (; (t = t.offsetParent); )
      if (
        ((e[0] += t.offsetTop + w(h(t, "borderTopWidth"))),
        (e[1] += t.offsetLeft + w(h(t, "borderLeftWidth"))),
        h(t, "position") === "fixed")
      ) {
        const i = Mt(t);
    ...
    return (
      ...
      h(t, "boxSizing") === i
        ? Ft[e]
            ...
            .reduce(
              (s, n) =>
                s + w(h(t, "padding" + n)) + w(h(t, "border" + n + "Width")),
              0
            )
        : 0
    );
  ...
  function Hi(t, e) {
    return $(
      $(t).map((i) => (i.hasChildNodes() ? Xe($(i.childNodes), e) : L(i, e)))
    );
  }
  function $e(t) {
    $(t)
  ...
  function Li(t) {
    Ps(G.reads),
      ...
      (G.scheduled = !1),
      (G.reads.length || G.writes.length) && Wi(t + 1);
  }
  const Lo = 4;
  function Wi(t) {
    G.scheduled ||
  ...
  (Z.events =
    ...
    (Z.update = function (t, e) {
      return Ne(qi(t, mt(e) ? { read: e } : e), "order");
    }),
  ...
  function Os(t) {
    if ((Qe(t) && Yi(t, { func: "playVideo", method: "play" }), Ze(t)))
      try {
        t.play().catch(T);
      } catch {}
  }
  function Bs(t) {
    Qe(t) && Yi(t, { func: "pauseVideo", method: "pause" }), Ze(t) && t.pause();
  }
  function Ds(t) {
    Qe(t) && Yi(t, { func: "mute", method: "setVolume", value: 0 }),
      Ze(t) && (t.muted = !0);
  }
  function Ms(t) {
    return Ze(t) || Qe(t);
    ...
    return s.reduce(
      (a, l, c) => {
        const { scrollTop: u, scrollHeight: d, offsetHeight: f } = l,
          m = rt(l),
          I = d - m.height,
          { height: P, top: W } = s[c - 1] ? rt(s[c - 1]) : C(t);
        let V = Math.ceil(W - m.top - i + u);
        return (
          i > 0 && f < P + i ? (V += i) : (i = 0),
          V > I ? ((i -= V - I), (V = I)) : V < 0 && ((i -= V), (V = 0)),
          () => n(l, V - u).then(a)
        );
      },
      () => Promise.resolve()
    ...
    return (
      ...
      [s]
        .concat(
          n.filter(
            (r) =>
              e.test(h(r, "overflow")) && (!i || r.scrollHeight > rt(r).height)
          )
        )
        .reverse()
    );
  ...
  function rt(t) {
    ...
    for (let [r, a, l, c] of [
      ...
      Jt(s) ? (s = i) : (o[l] += w(h(s, "border-" + l + "-width"))),
    ...
    for (const [l, [c, , u, d]] of Object.entries(at)) {
      ...
      if (r[l] === "flip") {
        ...
        const I = C(e[l]),
          { offset: P } = i;
        m =
          tt(tt(s[u], f[u], f[d] - s[c]), I[u] - s[c] + P[l], I[d] - P[l]) -
          s[u];
      }
      a = Ji(a, m, l);
    }
  ...
  function Xo(t, e, i, s) {
    let n = Ys(...Q(t).map(rt));
    return (
      e && ((n[at[s][2]] += e), (n[at[s][3]] -= e)),
      i && (n = Ys(n, C(U(i) ? i[s] : i))),
      n
    );
  }
  function Go(t, e, i) {
  ...
  function er(t) {
    ...
    (t.prototype._init = function (i) {
      ...
      (t.prototype._initObservers = function () {
        (this._observers = [ar(this)]),
          this.$options.computed && this.registerObserver(rr(this));
      }),
  ...
  function Gs(t) {
    ...
    for (const a in s) {
      ...
      let c = ot(n, l);
      R(c) ||
        ((c = s[a] === Boolean && c === "" ? !0 : Ki(s[a], c)),
        !(l === "target" && lt(c, "_")) && (e[a] = c));
    }
    const r = Se(ot(n, o), i);
    for (const a in r) {
      const l = fe(a);
      ...
      (t.prototype.$mount = function (i) {
        ...
        i[e] || (i[e] = {}),
          !i[e][s] &&
            ...
            _(i, document) && this._callConnected());
      }),
  ...
  async function dr(t, e, i) {
    ...
    o = (r * Vt + o) * (e ? 1 - ho : ho);
    const co = { [P]: e ? Vt : 0 };
    m && (h(t, W, Vt - Ot + ds), (co[W] = e ? ds : Vt + ds)),
      !m ^ (c === "reveal") &&
        (h(bi, W, -Vt + Ot), S.start(bi, { [W]: e ? 0 : -Vt }, o, a));
    try {
            ...
            (await Promise.all(
              i.map((n) =>
                this.toggleElement(n, !p(s, n), (o, r) => {
                  if (
                    (H(o, this.clsOpen, r),
                    v(b(this.$props.toggle, o), "aria-expanded", r),
                    e === !1 || !this.animation)
                  ) {
  ...
  async function pr(t, e, i) {
    ...
    const u =
        w(h(n, "height")) + w(h(n, "marginTop")) + w(h(n, "marginBottom")),
      d = c / u;
    (o = (r * u + o) * (e ? 1 - d : d)),
      h(l, "height", c),
    ...
    wr = {
      ...
      update: {
        read() {
          ...
          if (!o.width || !o.height) {
            ...
            o.width
              ? (o = t(c, "width", o.width))
              : n
              ? (o = t(c, "height", o.height))
              : (o = c);
          }
          const { offsetHeight: r, offsetWidth: a } = Qs(i) || A(i),
            l = e(o, {
              width: a + (a % 2 ? 1 : 0),
              height: r + (r % 2 ? 1 : 0),
            });
        ...
        write(t) {
          ...
          h(this.$el, { height: e, width: i });
        },
        events: ["resize"],
      },
    };
  function Qs(t) {
    for (; (t = A(t)); ) if (h(t, "position") !== "static") return t;
  }
  var le = {
  ...
  var Zi = {
    ...
    events: [
      ...
      },
      {
        ...
        handler() {
          N(
            ...
            this.stack &&
              h(this.$el, "zIndex", w(h(this.$el, "zIndex")) + nt.length),
      ...
      },
      {
        ...
        self: !0,
        handler() {
          We(this.$el) || v(this.$el, "tabindex", "-1"),
  ...
  function en(t) {
    if (CSS.supports("overscroll-behavior", "contain")) {
      ...
      return (
        h(s, "overscrollBehavior", "contain"),
        () => h(s, "overscrollBehavior", "")
      );
    }
    let e;
    const i = [
  ...
  function sn() {
    ...
    return (
      ...
      () => {
        (Qi = !1), h(t, { overflowY: "", touchAction: "", paddingRight: "" });
      }
    );
  }
  function yr(t, e) {
    ...
    connected() {
      x(this.$el, this.clsDrop),
        this.toggle &&
          ...
          v(this.targetEl, "aria-haspopup", !0),
        ...
        handler() {
          ...
          const t = () => this.$emit(),
            e = [
              ...
              ...(this.autoUpdate
                ? [k([document, Q(this.$el)], "scroll", t, { passive: !0 })]
                : []),
            ...
            h(this.$el, {
              [r]:
                (u[a] > d[a]
                  ...
                  : Math.min(C(this.boundary[n])[l], t[n][l] - e) - u[l]) - c,
              ["overflow-" + o]: "auto",
            }),
              this.positionAt(this.$el, this.target, this.boundary);
          }
  ...
  var kr = {
    ...
    on = {
      ...
      connected() {
        this.registerObserver(
          ji(this.$el, () => this.$reset(), { childList: !0 })
        );
      },
      update: {
        read() {
          const t = ts(this.$el.children);
          return { rows: t, columns: Sr(t) };
        },
        write(t) {
      ...
      },
      {
        read(t) {
          ...
          const n = D(this.$el),
            ...
            a = Math.max(...o) + r;
          this.masonry &&
            ((e = e.map((c) => Ne(c, "offsetTop"))), (s = Cr(i, e)));
        ...
        write(t) {
          ...
          h(this.$el, "paddingBottom", i || ""),
            e !== !1 && h(this.$el, "height", e);
        },
        events: ["resize"],
      },
      {
          ...
          return this.parallax && hn(this.$el)
            ...
            : {
                scrolled: this.parallax
                  ? Gi(this.$el) * Math.abs(this.parallax)
                  : !1,
              };
        },
        write(t) {
    ...
    update: {
      ...
      write(t) {
        ...
        for (const { heights: i, elements: s } of e)
          s.forEach((n, o) => h(n, "minHeight", i[o]));
      },
      events: ["resize"],
    },
  };
      ...
      update: {
        read(t) {
          ...
          const s = se(this.$el, "height", "content-box"),
            ...
            { height: a } = rt(r === n ? o : r);
          if (this.expand)
            i = Math.max(a - (y(r).height - y(this.$el).height) - s, 0);
          else {
            const l = o === r || n === r;
        ...
        write(t) {
          let { minHeight: e } = t;
          h(this.$el, { minHeight: e }),
            this.minHeight &&
              w(h(this.$el, "minHeight")) < this.minHeight &&
      ...
      methods: {
        async getSvg() {
          return ct(this.$el, "img") &&
            ...
            : Dr(await Br(this.src), this.icon) ||
                Promise.reject("SVG not found.");
        },
        applyAttributes(t, e) {
          for (const o in this.$options.props)
            p(this.include, o) && o in this && v(t, o, this[o]);
          ...
          n && !s.some((o) => o) && (s = n.split(" ").slice(2)),
            s.forEach((o, r) => v(t, i[r], w(o) * this.ratio || null));
        },
      },
    };
  const Br = ft(async (t) =>
  ...
  const ri = {
    ...
    na = {
      ...
      beforeConnect() {
        this.icon =
          "close-" + (E(this.$el, "bdt-close-large") ? "large" : "icon");
      },
    },
    oa = {
      extends: dt,
      methods: {
        async getSvg() {
          ...
          return (
            this.ratio !== 1 &&
              h(b("circle", t), "strokeWidth", 1 / this.ratio),
            t
          );
        },
      },
  ...
  function aa(t) {
    return ri[t]
      ? (ai[t] || (ai[t] = b((ri[la(t)] || ri[t]).trim())), ai[t].cloneNode(!0))
      : null;
  }
  function la(t) {
  ...
  var ca = {
    ...
    connected() {
      ...
      (ha &&
        li(this.$el) &&
        ((this.$el.loading = "lazy"), is(this.$el), t.length === 1)) ||
        (ga(this.$el),
        this.registerObserver(
          re(
            t,
    ...
    methods: {
      load() {
        ...
        const t = li(this.$el)
          ? this.$el
          : da(this.$el, this.dataSrc, this.sources);
        return (
          me(t, "loading"), is(this.$el, t.currentSrc), (this._data.image = t)
        );
      },
    },
  };
      ...
      update: {
        ...
        write(t) {
          ...
          H(this.wrapper, this.clsHide, s),
            v(this.wrapper, this.attrFill, new Array(e).join(i));
        },
        events: ["resize"],
      },
    },
      ...
      events: [
        {
          ...
          self: !0,
          handler() {
            E(this.panel, "bdt-margin-auto-vertical")
              ? x(this.$el, "bdt-flex")
  ...
  function xa(t) {
    ...
    (e.dialog = function (s, n) {
      const o = e(
        '<div class="bdt-modal"> <div class="bdt-modal-dialog">' +
          s +
          "</div> </div>",
        n
      );
        ...
        toggles: {
          ...
          watch() {
            ...
            for (const e of M(
              ...
              h(e, "flexGrow", t ? M(this.dropdown, e).length : "");
          },
          immediate: !0,
        },
      },
          ...
          handler(t) {
            ...
            this._observer = Ke([i.$el, ...i.target], () => {
              ...
              h(this.dropbar, "top", this.dropbar.offsetTop - (r.top - n)),
                this.transitionTo(o - n + w(h(e, "marginBottom")), e);
            });
          },
        },
        {
  ...
  var Sa = {
    ...
    events: [
      ...
      },
      {
        ...
        handler() {
          this.mode === "reveal" &&
            !E(A(this.panel), this.clsMode) &&
            (Xe(this.panel, "<div>"), x(A(this.panel), this.clsMode));
  ...
  var Ia = {
      ...
      update: {
        ...
        write(t) {
          let { max: e } = t;
          h(this.$el, { minHeight: this.minHeight, maxHeight: e });
        },
        events: ["resize"],
      },
    },
      ...
      update: {
        read() {
          return q(this.$el) && this.width && this.height
            ? { width: ye(A(this.$el)), height: this.height }
            : !1;
        },
        write(t) {
          J(
            ...
            re(
              ...
              (t) => {
                ...
                for (const { target: i, isIntersecting: s } of t) {
                  e.has(i) ||
                    e.set(i, { cls: ot(i, "bdt-scrollspy-class") || this.cls });
                  const n = e.get(i);
      ...
      methods: {
        toggle(t, e) {
          ...
          if (!!i) {
            if (
              (i.off == null || i.off(),
              h(t, "visibility", !e && this.hidden ? "hidden" : ""),
    ...
    Da = {
      ...
      connected() {
        (this.start = Tn(this.start || this.top)),
          ...
          (this.placeholder =
            b("+ .bdt-sticky-placeholder", this.$el) ||
            b('<div class="bdt-sticky-placeholder"></div>')),
          (this.isFixed = !1),
          this.setActive(!1);
      },
      disconnected() {
      ...
      update: [
        {
          read(t, e) {
            ...
            n && (h(this.selTarget, "transition", "0s"), this.hide()),
              this.active ||
                ((i = C(this.$el).height), (s = h(this.$el, "margin"))),
              n &&
                (this.show(),
                requestAnimationFrame(() =>
                  h(this.selTarget, "transition", "")
                ));
      ...
      methods: {
        ...
        update() {
          ...
          const u = n !== 0 || e > n;
          let d = "fixed";
          e > o && ((r += o - c), (d = "absolute")),
            i && (r -= s),
            h(this.$el, { position: d, top: r + "px", width: t }),
            this.setActive(u),
  ...
  var Cn = {
      ...
      computed: {
                ...
                (this._observer = ji(
                  ...
                  (i) => {
                    ...
                    for (const { target: n } of i)
                      D(n).forEach((o, r) => H(o, this.cls, r === s)),
                        this.lazyload(this.$el, D(n));
                  },
                  { childList: !0 }
                ))
              );
        ...
        toggles: {
          get(t, e) {
            let { toggle: i } = t;
            return M(i, e).filter(
              (s) => !F(s, ".bdt-disabled *, .bdt-disabled, [disabled]")
            );
          },
          watch(t) {
            const e = this.index();
      ...
      methods: {
        ...
        show(t) {
          ...
          D(this.$el).forEach((o, r) => {
            H(o, this.cls, s === r),
              v(this.toggles[r], "aria-expanded", s === r);
          });
          const n = e >= 0 && e !== i;
          this.connects.forEach(async (o) => {
            let { children: r } = o;
            await this.toggleElement(
              $(r).filter((a) => E(a, this.cls)),
              !1,
              n
            ),
    ...
    Ma = {
      ...
      connected() {
        const t = E(this.$el, "bdt-tab-left")
          ? "bdt-tab-left"
          : E(this.$el, "bdt-tab-right")
          ? "bdt-tab-right"
          : !1;
        t &&
  ...
  var za = {
      ...
      connected() {
        !p(this.mode, "media") && !We(this.$el) && v(this.$el, "tabindex", "0"),
          zi(() => this.$emit());
      },
      events: [
        {
  ...
  const Ha = ["days", "hours", "minutes", "seconds"];
  var La = {
    mixins: [st],
  ...
  function In(t, e, i, s) {
    ...
    const n = ci(e, !0),
      ...
      c = a(async () => {
        const u = J(e);
        x(e, ns), t(), h(D(e), { opacity: 0 }), await Ra();
        const d = D(e),
          f = J(e);
  ...
  async function qa(t, e, i) {
    ...
    await Promise.all(s.concat(e).map(S.cancel)),
      t(),
      (s = s.concat(D(e).filter((f) => !p(s, f)))),
      await Promise.resolve(),
      G.flush();
    const r = v(e, "style"),
      a = h(e, ["height", "padding"]),
      [l, c] = Ya(e, s, n),
      u = s.map((f) => ({ class: v(f, "class"), style: v(f, "style") }));
    s.forEach((f, m) => c[m] && h(f, c[m])), h(e, o), await On();
    const d = s
      .map((f, m) => A(f) === e && S.start(f, l[m], i, "ease"))
      .concat(S.start(e, a, i, "ease"));
    try {
      await Promise.all(d),
        s.forEach((f, m) => {
          v(f, u[m]),
            A(f) === e && h(f, "display", l[m].opacity === 0 ? "none" : "");
        }),
        v(e, "style", r);
    } catch {
      v(s, "style", ""), Va(e, o);
        ...
        async setState(t, e) {
          e === void 0 && (e = !0),
            ...
            this.toggles.forEach((i) =>
              H(i, this.cls, !!Ka(i, this.attrItem, t))
            ),
            await Promise.all(
    ...
    methods: {
      start() {
        (this.drag = this.pos),
          ...
          k(document, as, this.move, rs),
          k(document, Fn, this.end, zn),
      ...
      move(t) {
        ...
        [this.index, this.prevIndex]
          ...
          c && (!u && g(a, "itemhide", [this]), g(l, "itemshow", [this]));
      },
      end() {
        if (
          (Nt(document, as, this.move, rs),
          Nt(document, Fn, this.end, zn),
          this.dragging)
        )
  ...
  function nl(t) {
    return (
      h(t, "userSelect") !== "none" &&
      $(t.childNodes).some((e) => e.nodeType === 3 && e.textContent.trim())
    );
  }
  var ol = {
      data: { selNav: !1 },
      ...
      methods: {
        ...
        getIndex(t, e) {
          return (
            ...
            tt(Ut(t, this.slides, e, this.finite), 0, this.maxIndex)
          );
        },
        getValidIndex(t, e) {
          return (
        ...
        },
        {
          ...
          async handler(t, e) {
            ...
            if (
              ...
              try {
                const { width: c, height: u } = await ys(i, r.srcset, r.size);
                this.setItem(
                  e,
                  Ae("img", { src: i, width: c, height: u, alt: n, ...r })
                );
              } catch {
                this.setError(e);
              }
              ...
              k(c, "loadedmetadata", () => {
                v(c, { width: c.videoWidth, height: c.videoHeight }),
                  this.setItem(e, c);
              }),
  ...
  function ll(t, e) {
    t.lightboxPanel || t.component("lightboxPanel", Rn),
      ...
      (s, n) => {
        const [o, r, a] = Jn(i, n),
          l = o
            .map(
              (c, u) => (
                (c += a * (r[u] - c)), u === 3 ? w(c) : parseInt(c, 10)
              )
            )
            .join(",");
        s[t] = "rgba(" + l + ")";
  ...
  function fl(t, e, i) {
    ...
    const s = gi(i),
      n = fn(e);
    return (
      (i = ce(i.reverse(), (o) => ((o = w(o)), s === "%" ? (o * n) / 100 : o))),
      i.some((o) => {
        let [r] = o;
        return r;
      })
  ...
  var vl = {
    ...
    update: {
      read(t, e) {
        ...
        const s = i;
        return (
          (i = wl(Gi(this.target, this.start, this.end), this.easing)),
    ...
    return {
      ...
      show(u, d, f) {
        ...
        return (
          ...
          S.start(r, { transform: z(-c * (X ? -1 : 1), "px") }, u, m).then(
            a.resolve,
            T
          ),
          a.promise
      ...
      translate(u) {
        ...
        h(
          r,
          "transform",
          z(tt(-c + (d - d * u), -mi(r), y(r).width) * (X ? -1 : 1), "px")
        );
      ...
      percent() {
        return Math.abs(
          (h(r, "transform").split(",")[4] * (X ? -1 : 1) + l) / (c - l)
        );
      },
      getDistance() {
        return Math.abs(c - l);
  ...
  function vi(t, e) {
    return (
      (t && (je(t).left + (X ? y(t).width - y(e).width : 0)) * (X ? -1 : 1)) ||
      0
    );
  }
  function eo(t, e) {
      ...
      finite(t) {
        ...
        return (
          ...
          Math.ceil(mi(this.list)) <
            Math.trunc(y(this.list).width + $l(this.list) + this.center)
        );
      },
      maxIndex() {
      ...
      sets(t) {
        ...
        for (let o = 0; o < this.slides.length; o++) {
          ...
          i + r > n && (i = 0),
            this.center
              ? i < n / 2 &&
                i + r + y(this.slides[+o + 1]).width / 2 > n / 2 &&
                (s.push(+o), (i = n / 2 - r / 2))
      ...
      beforeitemshow(t) {
        ...
        const i =
          this.dir < 0 || !this.slides[this.prevIndex]
            ...
            : this.prevIndex;
        (this.duration =
          Ln(this.avgWidth / this.velocity) *
          (y(this.slides[i]).width / this.avgWidth)),
          this.reorder();
      },
      itemshow() {
        ~this.prevIndex &&
    ...
    methods: {
      ...
      updateActiveClasses() {
        const t = this._getTransitioner(this.index).getActives(),
          e = [
            this.clsActive,
            ((!this.sets || p(this.sets, w(this.index))) &&
              this.clsActivated) ||
              "",
          ];
      ...
      getAdjacentSlides() {
        const { width: t } = y(this.list),
          e = -t,
          i = t * 2,
          s = y(this.slides[this.index]).width,
        ...
        handler(t) {
          ...
          G.read(() => {
            const r = this.getCss(no(e, o, i)),
              a = this.getCss(so(e) ? 0.5 : o > 0 ? 1 : 0);
            G.write(() => {
        ...
        handles: {
          ...
          watch(t, e) {
            h(e, { touchAction: "", userSelect: "" }),
              h(t, { touchAction: Rt ? "none" : "", userSelect: "none" });
          },
          immediate: !0,
        },
      },
  ...
  function Cl(t) {
    ...
    oo = setInterval(() => {
      ...
      (e = Date.now()),
        Q(document.elementFromPoint(i, t.y), /auto|scroll/)
          .reverse()
          .some((o) => {
  ...
  function El(t, e, i, s, n, o) {
    ...
    if (!o)
      return _l(t, i) || n < r.top + r.height / 2 ? e : e.nextElementSibling;
  ...
  var Ol = {
    ...
    beforeConnect() {
      (this.id = "bdt-tooltip-" + this._uid),
        ...
        v(this.$el, { title: "", "aria-describedby": this.id }),
        Bl(this.$el);
    },
    disconnected() {
